...
import example.spring.dto.BankCardValidateBaseReqSortDto;
...
//        req.setSort(Sort.by(new Sort.Order(Sort.Direction.DESC, "inserttime")));
    ...
    @Test
    public void testNameValidationWithSort() {
        BankCardValidateBaseReqSortDto req = new BankCardValidateBaseReqSortDto();
        req.setBusinessNo("nameValidation:55:1");
        req.setUserId(55L);
        req.setAccountName("Philippine Gazzo");
        req.setBankCode("MANDIRI");
